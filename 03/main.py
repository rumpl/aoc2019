...
class Line:
    ...
    def intersect(self, other):
        if self.a.x < other.a.x < self.b.x and other.a.y < self.a.y < other.b.y:
            return Point(other.a.x, self.b.y)
        if self.b.x < other.a.x < self.a.x and other.b.y < self.a.y < other.a.y:
            return Point(other.a.x, self.b.y)

        if other.a.x < self.a.x < other.b.x and self.a.y < other.a.y < self.b.y:
            return Point(self.a.x, other.b.y)
        if other.b.x < self.a.x < other.a.x and self.b.y < other.a.y < self.a.y:
            return Point(self.a.x, other.b.y)
...
def line(start, direction):
    ...
    end = Point(start.x + size * dx, start.y + size * dy)
